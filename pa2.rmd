...
barplot(event_economic$DAMAGE, names.arg=event_economic$EVTYPE, 
        ylab="Damages Amount in USD", 
        las=3, 
        col = "blue",
        main="Top 10 Events causing the most damages to properties and crop")
